...
use Lan\TournamentBundle\Entity\Round;
use Lan\TournamentBundle\Form\RoundType;
...
class RoundController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LanTournamentBundle:Round')->findAll();
     ...
     *
     * @Route("/", name="admin_round_create")
     * @Method("POST")
     * @Template("LanTournamentBundle:Round:new.html.twig")
     */
     ...
     *
     * @Route("/new", name="admin_round_new")
     * @Method("GET")
     * @Template()
     */
     ...
     *
     * @Route("/{id}", name="admin_round_show")
     * @Method("GET")
     * @Template()
     */
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LanTournamentBundle:Round')->find($id);
     ...
     *
     * @Route("/{id}/edit", name="admin_round_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    */
     ...
     *
     * @Route("/{id}", name="admin_round_update")
     * @Method("PUT")
     * @Template("LanTournamentBundle:Round:edit.html.twig")
     */
     ...
     *
     * @Route("/{id}", name="admin_round_delete")
     * @Method("DELETE")
     */
