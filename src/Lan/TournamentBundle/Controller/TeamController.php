...
use Lan\TournamentBundle\Form\TeamType;
...
class TeamController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LanTournamentBundle:Team')->findAll();
     ...
     * @Method("POST")
     * @Template("LanTournamentBundle:Team:new.html.twig")
     */
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_team_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Team $entity)
    {
        $form = $this->createForm(new TeamType(), $entity, array(
            'action' => $this->generateUrl('admin_team_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LanTournamentBundle:Team')->find($id);
    ...
    */
    ...
    {
        $form = $this->createForm(new TeamType(), $entity, array(
            'action' => $this->generateUrl('admin_team_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     * @Method("PUT")
     * @Template("LanTournamentBundle:Team:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_team_delete', array('id' => $id)))
            ->setMethod('DELETE')
